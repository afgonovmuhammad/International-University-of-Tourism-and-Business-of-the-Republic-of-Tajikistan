        ...
        <div>
            <div className="main-1">
                <div className="contener">
                    <h1 className=' bg-[#003197] text-[#FFF] py-[20px] text-center my-[2px] uppercase text-[44px] font-[500]' >{t("text9")}</h1>
                    <div className="main-1A py-[60px]">
                        <div className="contener w-[80%] m-auto">
                            <h1 className='  text-[44px] font-[500]' data-aos="zoom-in-up">{t("text53")} </h1>
