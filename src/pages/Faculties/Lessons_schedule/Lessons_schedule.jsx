        ...
        <div>
            <div className="main-1 py-[90px]">
                <div className="contener w-[80%] m-auto">
                    <h1 className='text-[42px] pb-[30px] font-[500]'>{t("text48C")}</h1>
                    <div>
                        <div className='w-[90%] border-[2px] rounded-[5px]'>
                            <Accordion className=''>
                                <AccordionSummary
...
export default Lessons_schedule